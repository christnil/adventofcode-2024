...
const isBroken = (x, y, at) => broken[x] && broken[x][y] < LIMIT;
...
let part1 = aStar()
draw(part1.path)
console.log('Part1: ', part1.best);
console.log(JSON.stringify(part1.path))
